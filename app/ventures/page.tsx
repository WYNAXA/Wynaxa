    ...
    <>
          ...
          <div className="space-y-6">
            {stages.map((s) => (
              ...
              >
                ...
                <div>
                  <h2 className="text-2xl font-semibold tracking-tight text-[#0F1B33]">
                    {s.title}
                  </h2>
                  <p className="mt-2 font-medium text-[#0F1B33]">{s.lead}</p>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="flex flex-col items-start justify-between gap-6 rounded-lg bg-[#0F1B33] p-10 sm:flex-row sm:items-center">
            <div>
